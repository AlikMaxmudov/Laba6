...
public class FractalExplorer {
    ...
    /**
     *
     * Вычисляет цвета всех пикселей в строке для выбранного комплексаPlaneRange и фрактального типа в фоновом потоке.
     *
     */
    class FractalWorker extends SwingWorker<Object, Object> {
        /**
         * индекс строки для рендеринга
         */
        private final int selectedY;
        /**
         * уже рассчитанные цвета для строки
         */
