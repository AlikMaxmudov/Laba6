...
public class FractalExplorer {
    ...
    /**
     * прослушиватель на кнопку «сброс». восстановить масштаб и перерисовать фрактал.
     */
    ...
    /**
     * слушатель по щелчку мыши. увеличить и перерисовать фрактал
     */
